      ...
      <div class="card card-xxl-stretch">
        ...
        <div class="card-body d-flex flex-column justify-content-between h-100">
          ...
          <div class="pt-12">
            ...
            <!--end::Text-->
            <div class="my-5 flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom card-rounded-bottom h-250px" style="background-image:url('<?=base_url()?>/public/user/assets/media/illustrations/run.png')"></div>
