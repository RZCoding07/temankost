        ...
        <div class="card-body d-flex flex-column justify-content-between h-100">
          ...
          <div class=" position-relative">
            ...
            <form action="" method="post">
              <input type="text" class="form-control form-control-solid form-control-lg " placeholder="Masukan * (Nama Kost, Alamat, Harga, Kategori)" name="q" />
              <!--end::Input-->
              <!-- buatlah range harga dari 2 inputan -->
              <div class="position-absolute translate-middle-y top-50 end-0 me-3" style="margin-top: -6000px;">
              ...
              <div class="row mt-5">
                <div class="col">
                  <input type="number" class="form-control form-control-solid form-control-lg " placeholder="Harga Min (Jangan Gunakan tanda .)" name="min" />
                </div>
                <div class="col">
                  <input type="number" class="form-control form-control-solid form-control-lg " placeholder="Harga Max (Jangan Gunakan tanda .)" name="max" />
                </div>
              </div>
              <div class="row mt-5">
                <div class="col">
          ...
          <div class="row g-5">
            ...
            foreach ($data as $kost) : ?>
              <div class="mb-5 col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card-bordered card-flush card-stretch my-card" style="background-image:url('<?= base_url()  . '/public/uploads/' . $kost['id'] . '/' . $kost['foto'] ?>')">
