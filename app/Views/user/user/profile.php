            ...
            <div class="me-7 mb-4">
              <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                ...
                <?php if (session()->get('image')) :?>
                  <img src="<?=session()->get('image')?>" alt="image">
                <?php else :?>
                  <img src="<?=base_url()?>/public/user/assets/media/avatars/avatar.svg" alt="image">
                <?php endif;?>
            ...
            <div class="flex-grow-1">
              ...
              <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                ...
                <div class="d-flex my-2">
                  <?php if (!$isPemilik) :?>
                  <button href="#" class="btn btn-primary me-3" onclick="showNotification()">
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content" id="isi" >
				<div class="modal-header">
        			<h5 class="modal-title" id="exampleModalLabel">Silahkan Hubungi Admin</h5>
				    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      			</div>
              	<div class="modal-body">
                  <h7 class="modal-title" id="exampleModalLabel">+62 852 1182 7766 (A/n Celvin Januar)</h7>
                </div>
			</div>
		</div>
	</div>
...
<!-- Start script custom HARY-IT -->


<!-- end script custom HARY-IT -->
