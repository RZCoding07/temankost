...
<script>
	...
	// tampil form edit
	function apah(id) {
		Crud.getHtml('/admin/pengguna/apah/' + id, (result) => {
			$('#isi').html(result);
		});
      ...
      <form id="add-form" action="" method="_post">
	      <div class="modal-body" data-scroll="false" data-height="500">
					...
					<div class="form-group">
						...
						<input type="number" value="" name="telepon" class="form-control" placeholder="Nomor Telepon" required="">
					</div>
					<div class="form-group">
						<label>Pemilik<span class="text-danger">*</span></label>
						<select required name="pemilik" class="form-control">
		...
		$('#add-form').submit(function (e) {
			...
			Crud.post('<?= base_url() ?>/admin/pengguna/add', form, (result) => {
