	      ...
	      <div class="modal-body" data-scroll="false" data-height="500">
	      	<input type="hidden" name="id" value="<?=$data['id'] ?>">
					<div class="form-group">
						...
						<input type="text" value="<?=$data['nama'] ?>" name="nama" class="form-control"  placeholder="Nama" required="" />
					</div>
					...
					<div class="form-group">
						...
						<input type="number" value="<?=$data['telepon'] ?>" name="telepon" class="form-control"  placeholder="Nomor Telepon" required=""/>
					</div>
					<div class="form-group">
					   
						<label>Pemilik<span class="text-danger">*</span></label>
						<input type="text" value="<?=$data['pemilik'] ?>" name="pemilik" class="form-control"  placeholder="Masukan Email" required="" />
					</div>
