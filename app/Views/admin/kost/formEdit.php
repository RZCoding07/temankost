...
<form id="edit-form" action="" method="_post">
	<div class="modal-body" style="height: 500px; overflow: auto;">
		...
		<div class="form-group">
			...
			<input type="number" value="<?= $data['harga'] ?>" name="harga" class="form-control" placeholder="Masukan Harga" required="" />
		</div>
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label><span class="text-danger"></span></label>
				<textarea name="peraturan" rows="5" class="form-control" readonly placeholder="Peraturan Indekos (Waajib Diisi)" id="peraturan-textarea"></textarea>
			</div>
				<div class="form-group">
				<label>Alamat <span class="text-danger">*</span></label>
				<textarea name="alamat" rows="5" class="form-control" placeholder="Masukan Alamat"><?= $data['alamat'] ?></textarea>
			</div>
			<div class="form-group">
				<label>Koordinat <span class="text-danger">*</span></label>
				<input type="text" value="<?= $data['kordinat'] ?>" name="kordinat" class="form-control" placeholder="Masukan Kordinat" required="" />
			</div>
