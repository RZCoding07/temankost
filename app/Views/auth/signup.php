...
<html lang="en">
	...
	<body id="kt_body" class="bg-white">
					...
					<div class="col-12 col-lg-5 bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" method="POST" novalidate="novalidate" id="kt_sign_up_form" action="<?=base_url()?>/Auth/up">
							...
							<div class="mb-10 text-center">
								<!--begin::Title-->
      					<h1 class="text-dark fw-bolder my-1 fs-2"><img src="<?=base_url()?>/public/logo/temankost.png" alt="logo" height="130">
		...
		<script src="<?=base_url()?>/public/user/assets/js/custom/auth/signup.js"></script>
