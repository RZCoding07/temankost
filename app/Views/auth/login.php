...
<html lang="en">
	...
	<body id="kt_body" class="bg-white">
					...
					<div class="col-12 col-lg-4 bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" method="POST" novalidate="novalidate" id="kt_sign_in_form" action="<?=base_url()?>/Auth/in">
							...
							<div class="text-center mb-8">
								<!--begin::Title-->
      					<h1 class="text-dark fw-bolder mt-2 mb-4 fs-2"><img src="<?=base_url()?>/public/logo/temankost.png" alt="logo" class="img-fluid">
		...
		<script src="<?=base_url()?>/public/user/assets/js/custom/auth/general.js"></script>
		...
		var startApp = function() {
			gapi.load('auth2', function(){
				...
				auth2 = gapi.auth2.init({
					client_id: '401957911396-6s53t7nfe1ij0r2gfd80ijg08rj96dlv.apps.googleusercontent.com',
